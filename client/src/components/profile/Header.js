...
export default class Header extends Component {
    ...
    render() {
        return (
        <div className="media">
            <img className="mr-3 avatar" src={this.props.sponsor ? DefaultSponsorPfp : DefaultPfp} style={{width: '200px', position: "relative", textalign: "center"}} alt= ""/>
            <div className="media-body">
                <h5 className="mt-0 handle"><strong>@{this.props.handle}</strong></h5>
