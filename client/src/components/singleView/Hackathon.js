...
const Hackathon = ({ match, getHackathon, hackathon : {title, description, prizes, requirements, criteria, location, judges, website, donations, startDate, endDate, winners} }) => {
  useEffect(() => {
  ...
  {website ? <a href={website}><i className = 'fas fa-globe'></i></a> : null}
