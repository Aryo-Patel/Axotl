    ...
    <Fragment>
      <div className="text-center landingLogin">
        ...
        <div className="block2 block">
          <div className="innerBlock cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            <svg
            ...
            <div className="row">
              ...
              <div className="col col-12 col-sm-8 col-md-6">
                <p className="lead">
                  Bringing local companies and individuals together with
                  hackathon organizers to foster young talent and support tech
                  initiatives.
                </p>
              </div>
              <div className="col col-sm-2 col-md-3"></div>
        ...
        <div className="block1 block">
          <div className="innerBlock cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <h1 className="cover-heading home-head">
