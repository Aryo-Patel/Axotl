...
const NavBar = ({isAuthenticated, isSponsor, auth}) => {
  const authRecLinks = (
    <ul className = 'navbar-nav special-links recipient-links'>
  ...
  return (
    <Fragment>
      <div className ="navbar navbar-light navbar-expand-lg" style={{width: "100%", backgroundColor: "#87ffa7", opacity: "100%", display: "flex", alignItems: "space-between"}}>
     
      <nav
        className="navbar navbar-light navbar-expand-lg"
        style={{ flexGrow: "1",backgroundColor: "#87ffa7", opacity: "75%"}}
      >
